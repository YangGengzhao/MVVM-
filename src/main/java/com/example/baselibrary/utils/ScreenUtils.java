...
//        }
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        return ScreenUtils.dp2px(context, 20);
    }


    public static void do_FullScreen(Activity context, boolean darkFont) {
        Window window = context.getWindow();
        View decorView = window.getDecorView();
        int option = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN;
        if (darkFont) option = option | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR;
        else option = option | View.SYSTEM_UI_FLAG_LAYOUT_STABLE;
