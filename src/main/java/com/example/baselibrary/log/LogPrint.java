...
public class LogPrint {
     ...
     * @param explainString
     */
    protected static void println(int logLevel, String tagString, String explainString, boolean isUpLoad) {
     ...
     * @param throwable
     */
    protected static void println(int logLevel, String tagString, String explainString, Throwable throwable, boolean isUpLoad) {
        switch (logLevel) {
