...
import com.example.baselibrary.constants.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(BaseApplication.baseContext.getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = BaseApplication.baseContext.getPackageManager();
//        pm.getPackagesForUid()
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(BaseApplication.baseContext, permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + BaseApplication.baseContext.getPackageName()));
        BaseApplication.baseContext.startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(BaseApplication.baseContext);
    }
    ...
    public static class PermissionActivity extends Activity {
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (sInstance == null) {
                ...
                MLog.e("PermissionUtils", "request permissions failed");
                finish();
                return;
            }
